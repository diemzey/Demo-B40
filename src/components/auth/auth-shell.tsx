...
import { AuthBusyBar, AuthBusyProvider } from "@/components/auth/auth-busy";
 ...
 *
 * El estado "ocupado" de los formularios (ver `auth-busy.tsx`) se refleja
 * como una barra de progreso fina en el borde superior del panel amarillo.
 */
  ...
  return (
    <AuthBusyProvider>
      ...
      >
        ...
        <aside className="relative hidden flex-col bg-yellow-400 p-10 text-neutral-950 lg:flex xl:p-14">
          <AuthBusyBar />
          ...
          <div className="my-auto max-w-md">
            ...
            <p className="mt-4 text-pretty text-lg leading-snug text-neutral-950/70">{subline}</p>
          </div>
        </aside>
