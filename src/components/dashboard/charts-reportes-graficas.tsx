...
import {
  ...
  fmtMXN,
  pct,
} from "@/components/dashboard/charts-tema";
 ...
 *
 * Este archivo trae recharts; `charts-reportes.tsx` carga cada gráfica con
 * `next/dynamic` (`ssr: false`) y conserva la API pública.
 */
...
export function AhorroPorSemanaGrafica({ semanas }: { semanas: FilaReporte[] }) {
 ...
 */
export function DesgloseAhorroGrafica({ desglose }: { desglose: DesgloseAhorro }) {
